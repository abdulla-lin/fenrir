...
'bypass_security_control_3': PatchStage('bypass_security_control_3', pattern='f6 9f 00 94 e0 00 f8 37', replacement='f6 9f 00 94 1f 20 03 d5', match_mode=MatchMode.ALL, description='Skip security error branch #3'),
    ...
    Device(
        ...
        'CMF Phone 1',
        {
            # CORE PATCHES - These are essential and proven safe
            'sec_get_vfy_policy': PatchStage(
                'sec_get_vfy_policy',
                pattern='00 01 00 b4 fd 7b bf a9',
                replacement='00 00 80 52 c0 03 5f d6',
            ...
            # MINIMAL VERIFICATION BYPASS - Only the most critical ones
            'bypass_security_control': PatchStage(
                'bypass_security_control',
                pattern='24 74 01 94 20 01 00 36',
                replacement='24 74 01 94 1f 20 03 d5',
