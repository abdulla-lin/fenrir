...
DEVICES = [
    ...
    Device(
        ...
        'disable_avb_verification_1': PatchStage(
            'disable_avb_verification_1',
            pattern='19 a0 00 94 00 01 f8 37',
            replacement='19 a0 00 94 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Disable AVB verification gate #1',
        ),
        'disable_avb_verification_2': PatchStage(
            'disable_avb_verification_2',
            pattern='f6 9f 00 94 e0 00 f8 37',
            replacement='f6 9f 00 94 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Disable AVB verification gate #2',
        ),
        'disable_avb_verification_3': PatchStage(
            'disable_avb_verification_3',
            pattern='d5 9f 00 94 e0 00 f8 37',
            replacement='d5 9f 00 94 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Disable AVB verification gate #3',
        ),
        'disable_avb_verification_4': PatchStage(
            'disable_avb_verification_4',
            pattern='b4 9f 00 94 00 01 f8 37',
            replacement='b4 9f 00 94 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Disable AVB verification gate #4',
        ),
        'disable_avb_verification_5': PatchStage(
            'disable_avb_verification_5',
            pattern='7e 9f 00 94 80 01 f8 37',
            replacement='7e 9f 00 94 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Disable AVB verification gate #5',
        ),        'avb_bypass_00000': PatchStage(
            'avb_bypass_00000',
            pattern='28 07 ff 97 80 fe ff b4',
            replacement='28 07 ff 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022D2F4',
        ),
        'avb_bypass_00001': PatchStage(
            'avb_bypass_00001',
            pattern='38 f5 ff 97 20 fe ff 35',
            replacement='38 f5 ff 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022D300',
        ),
        'avb_bypass_00002': PatchStage(
            'avb_bypass_00002',
            pattern='7f 2b ff 97 e0 09 00 b4',
            replacement='7f 2b ff 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022D3CC',
        ),
        'avb_bypass_00003': PatchStage(
            'avb_bypass_00003',
            pattern='ae 82 fe 97 e0 00 00 b4',
            replacement='ae 82 fe 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022DA5C',
        ),
        'avb_bypass_00004': PatchStage(
            'avb_bypass_00004',
            pattern='94 82 fe 97 e0 00 00 b4',
            replacement='94 82 fe 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022DAC4',
        ),
        'avb_bypass_00005': PatchStage(
            'avb_bypass_00005',
            pattern='b4 82 fe 97 40 01 00 34',
            replacement='b4 82 fe 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022DB18',
        ),
        'avb_bypass_00006': PatchStage(
            'avb_bypass_00006',
            pattern='64 82 fe 97 40 02 00 b4',
            replacement='64 82 fe 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
            description='Bypass AVB verification near fail at 0x0022DB84',
        ),
        'avb_bypass_00007': PatchStage(
            'avb_bypass_00007',
            pattern='7f 2b ff 97 e0 09 00 b4',
            replacement='7f 2b ff 97 1f 20 03 d5',
            match_mode=MatchMode.ALL,
